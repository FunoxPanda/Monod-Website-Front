                ...
                <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
                    <div class="offcanvas-header">
                        <h5 class="offcanvas-title" id="offcanvasExampleLabel">
                            <img src={process.env.PUBLIC_URL + "/assets/images/logotext.jpg"} alt="Logo Gustave Monod" style={{ // useRems
                                height: "3rem"
                            }} />
                        </h5>
                    ...
                    <div class="offcanvas-body">
                        ...
                        <NavLink className="text-link" to="/formations">Formations</NavLink><br /><br />
                        ...
                        <NavLink className="text-link" to="/union/lyceene">Union des instances lycéennes</NavLink><br /><br />

                        <NavLink className="text-link" to="/404">Partenaires</NavLink><br /><br /><br />
